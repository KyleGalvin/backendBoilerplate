...
import {MockUser, IUserSerialized} from "../test/models/user";
...
export class Fixture {
    public readonly testUser: MockUser = {
      id: -1, 
      username: "testuser", 
    ...
    public readonly modifiedTestUser: MockUser = {
      id: -1, 
      username: "testuser2", 
    ...
    public testRepositoryUsers: MockUser[] | undefined = undefined;
    public findCalls = 0;
    public saveCalls = 0;
